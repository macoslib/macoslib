...
Protected Module CertTools
	...
	#tag Method, Flags = &h1
		Protected Function IsValid(guid as String, receipt as Dictionary) As Boolean
		  ...
		  declare sub SHA1 lib "libCrypto.dylib" (d as Ptr, n as Int32, md as Ptr)
	...
	#tag Method, Flags = &h1
		Protected Function ReadReceipt(certFile as FolderItem) As Dictionary
		  ...
		  declare function d2i_PKCS7_fp lib "libCrypto.dylib" (fp as Int32, p7 as Ptr) as Ptr
		  declare sub PKCS7_free lib "libCrypto.dylib" (p7 as Ptr)
		  declare function OBJ_obj2nid lib "libCrypto.dylib" (ASN1_OBJECT as Ptr) as Int32
		  declare function ASN1_get_object lib "libCrypto.dylib" (ByRef pp as Ptr, ByRef plength as Int32, ByRef ptag as Int32, ByRef pclass as Int32, omax as Int32) as Int32
