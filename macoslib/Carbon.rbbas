...
Protected Module Carbon
	...
	#tag Method, Flags = &h21
		Private Function GetLanguages() As String()
		  ...
		  soft declare function CFArrayGetCount lib CarbonLib (theArray as Ptr) as Integer
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Function ReadSystemVersion() As String
		  ...
		  '
		  '#if targetMacOS
		  'soft declare function CFURLCreateWithFileSystemPath lib CarbonLib (allocator as ptr, filePath as CFStringRef, pathStyle as Integer, isDirectory as Boolean) as Ptr
		  ...
		  '
		  'soft declare function CFPropertyListCreateFromXMLData lib CarbonLib (allocator as Ptr, xmlData as Ptr, mutabilityOption as UInt32, errorString as Ptr) as Ptr
		  ...
		  'soft declare function CFDictionaryGetTypeID lib CarbonLib() as UInt32
		  ...
		  'end if
		  '
		  'soft declare function CFDictionaryGetValue lib CarbonLib (theDict as Ptr, key as CFStringRef) as CFStringRef
		  '
