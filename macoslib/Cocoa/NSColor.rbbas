...
Inherits NSObject
	...
	#tag Method, Flags = &h21
		Private Function ComputeColorValue() As Color
		    ...
		    declare sub getRGBComponents lib Cocoa selector "getRed:green:blue:alpha:" (id as Ptr, ByRef red as Single, ByRef green as Single, ByRef blue as Single, alpha as Ptr)
	...
	#tag Method, Flags = &h0
		Sub Constructor(c as Color, alpha as Double = 1.0)
		  #if TargetMacOS
		    declare function colorFromRGBA lib Cocoa selector "colorWithCalibratedRed:green:blue:alpha:" (class_id as Ptr, red as Single, green as Single, blue as Single, alpha as Single) as Ptr
