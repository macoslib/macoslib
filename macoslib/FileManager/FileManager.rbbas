...
Module FileManager
	#tag Method, Flags = &h1
		Protected Function GetFolderItemFromFSRef(theFSRef as FSRef) As FolderItem
		  #if targetMacOS
		    soft declare function FSGetCatalogInfo lib CarbonLib (ByRef ref as FSRef, whichInfo as Uint32, ByRef catalogInfo as FSCatalogInfo, outName as Ptr, fsSpec as Ptr, ByRef parentRef as FSRef) as Int16
		    ...
		    If parentDirectoryID = fsRtParID then //is root directory, and parentRef is invalid
		      ...
		      soft declare function FSGetCatalogInfo lib CarbonLib (ByRef ref as FSRef, whichInfo as Uint32, catalogInfo as Ptr, ByRef outName as HFSUniStr255, fsSpec as Ptr, parentRef as Ptr) as Int16
		...
		Protected Function GetFSRefFromFolderItem(f as FolderItem) As FSRef
		  if f is nil then
		    ...
		    if f.Parent is nil then //f should be the root directory of the volume
		      soft declare function FSGetVolumeInfo lib CarbonLib (volume as Int16, volumeIndex as Integer, actualVolume as Ptr, whichInfo as UInt32, info as Ptr, volumeName as Ptr, ByRef rootDirectory as FSRef) as Int16
		      ...
		      soft declare function FSMakeFSRefUnicode lib CarbonLib (ByRef parentRef as FSRef, nameLength as Integer, name as CString, enc as UInt32, ByRef outRef as FSRef) as Int16
