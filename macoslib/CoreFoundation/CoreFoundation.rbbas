...
Module CoreFoundation
	...
	#tag Method, Flags = &h0
		Function CFConstant(name as String) As CFStringRef
		  ...
		  dim p as Ptr = CFBundle.CarbonFramework.DataPointer(name)
		  if p <> nil then
	...
	#tag Method, Flags = &h1
		Protected Sub _TestSelf()
		  // This is an incomplete set of tests to make sure nothing got screwed up too much
		    ...
		    if false then
		      // (TT 6 Dec 09) this is not working - at least not when reading and writing form in same process
