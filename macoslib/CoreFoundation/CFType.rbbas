...
Class CFType
	...
	#tag Method, Flags = &h0
		Function TypeID() As CFTypeID
		  #if TargetMacOS
		    soft declare function CFGetTypeID lib CarbonLib (cf as Ptr) as CFTypeID
	...
	#tag Method, Flags = &h0
		 Shared Function TypeDescription(id as CFTypeID) As String
		  #if TargetMacOS
		    soft declare function CFCopyTypeIDDescription lib CarbonLib (id as CFTypeID) as Ptr
