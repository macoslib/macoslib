...
Class CFPreferences
	...
	#tag Method, Flags = &h0
		 Shared Function Value(key as String) As CFType
		  ...
		  #if targetMacOS
		    soft declare function CFPreferencesCopyAppValue lib CarbonLib (key as CFStringRef, applicationID as Ptr) as Ptr
	...
	#tag Method, Flags = &h0
		 Shared Sub Value(key as String, assigns theValue as CFPropertyList)
		  #if targetMacOS
		    soft declare sub CFPreferencesSetAppValue lib CarbonLib (key as CFStringRef, value as Ptr, applicationID as Ptr)
