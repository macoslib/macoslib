...
Implements CFPropertyList
	...
	#tag Method, Flags = &h0
		Function Value(index as Integer) As CFType
		    ...
		    return CFType.NewObject(CFArrayGetValueAtIndex(me.Reference, index), false)
		  #endif
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub Constructor(theList() as CFType)
		    ...
		    me.Adopt CFArrayCreate(nil, me.GetValuesAsCArray(theList), UBound(theList) + 1, me.defaultCallBacks), true
		  #endif
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Function DefaultCallbacks() As Ptr
		  ...
		  return CFBundle.CarbonFramework.DataPointer(kCFTypeArrayCallBacks)
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		 Shared Function ClassID() As CFTypeID
		  #if targetMacOS
		    soft declare function CFArrayGetTypeID lib CarbonFramework () as CFTypeID
		    static id as CFTypeID = CFArrayGetTypeID
		    return id
		  #endif
		End Function
	#tag EndMethod
