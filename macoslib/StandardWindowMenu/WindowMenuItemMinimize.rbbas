#tag Class
Protected Class WindowMenuItemMinimize
Inherits WindowMenuItem
	...
	#tag Event
		Function CommandID() As OSType
		  const kHICommandMinimizeWindow = "mini"
		  return kHICommandMinimizeWindow
		End Function
	#tag EndEvent


	#tag Constant, Name = MenuItemText, Type = String, Dynamic = True, Default = \"Minimize", Scope = Private
