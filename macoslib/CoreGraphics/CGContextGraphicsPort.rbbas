...
Inherits CGContext
	#tag Method, Flags = &h0
		Sub Destructor()
		  ...
		  #if targetMacOS
		    soft declare sub CGContextSynchronize lib CarbonFramework (context as Ptr)
	...
	#tag Method, Flags = &h0
		Sub Constructor(w as Window)
		  ...
		  #if targetMacOS
		    soft declare function GetWindowPort lib CarbonFramework (window as WindowPtr) as Ptr
