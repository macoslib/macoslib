...
Inherits CFType
	...
	#tag Method, Flags = &h0
		 Shared Function ClassID() As CFTypeID
		  soft declare function CGContextGetTypeID lib CarbonFramework () as CFTypeID
	...
	#tag Method, Flags = &h0
		Sub AddLineToPoint(x as Double, y as Double)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextAddLineToPoint lib CarbonFramework (context as Ptr, x as Single, y as Single)
	...
	#tag Method, Flags = &h0
		Sub AddPath(path as CGPath)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextAddPath lib CarbonFramework (context as Ptr, path as Ptr)
	...
	#tag Method, Flags = &h0
		Sub AddQuadCurveToPoint(cpx as Double, cpy as Double, x as Double, y as Double)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextAddQuadCurveToPoint lib CarbonFramework (path as Ptr, cpx as Single, cpy as Single, x as Single, y as Single)
	...
	#tag Method, Flags = &h0
		Sub AddRect(rect as CGRect)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextAddRect lib CarbonFramework (context as Ptr, rect as CGRect)
	...
	#tag Method, Flags = &h0
		Sub AddRects(rects() as CGRect)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextAddRects lib CarbonFramework (context as Ptr, rects as Ptr, count as Integer)
	...
	#tag Method, Flags = &h0
		Sub BeginPath()
		  ...
		  #if targetMacOS
		    soft declare sub CGContextBeginPath lib CarbonFramework (context as Ptr)
	...
	#tag Method, Flags = &h0
		Sub ClosePath()
		  ...
		  #if targetMacOS
		    soft declare sub CGContextClosePath lib CarbonFramework (context as Ptr)
	...
	#tag Method, Flags = &h0
		Sub MoveToPoint(x as Double, y as Double)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextMoveToPoint lib CarbonFramework (context as Ptr, x as Single, y as Single)
	...
	#tag Method, Flags = &h0
		Sub AddEllipseInRect(rect as CGRect)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextAddEllipseInRect lib CarbonFramework (context as Ptr, rect as CGRect)
	...
	#tag Method, Flags = &h0
		Sub DrawPath(mode as CGPathDrawingMode)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextDrawPath lib CarbonFramework (context as Ptr, mode as CGPathDrawingMode)
	...
	#tag Method, Flags = &h0
		Sub EOFillPath()
		  ...
		  #if targetMacOS
		    soft declare sub CGContextEOFillPath lib CarbonFramework (context as Ptr)
	...
	#tag Method, Flags = &h0
		Sub FillPath()
		  ...
		  #if targetMacOS
		    soft declare sub CGContextFillPath lib CarbonFramework (context as Ptr)
	...
	#tag Method, Flags = &h0
		Sub FillRects(rects() as CGRect)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextFillRects lib CarbonFramework (context as Ptr, rects as Ptr, count as Integer)
	...
	#tag Method, Flags = &h0
		Sub FillEllipseInRect(rect as CGRect)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextFillEllipseInRect lib CarbonFramework (context as Ptr, rect as CGRect)
	...
	#tag Method, Flags = &h0
		Sub StrokePath()
		  ...
		  #if targetMacOS
		    soft declare sub CGContextStrokePath lib CarbonFramework (context as Ptr)
	...
	#tag Method, Flags = &h0
		Sub StrokeRect(rect as CGRect)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextStrokeRect lib CarbonFramework (context as Ptr, rect as CGRect)
	...
	#tag Method, Flags = &h0
		Sub StrokeRect(rect as CGRect, width as Double)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextStrokeRectWithWidth lib CarbonFramework (context as Ptr, rect as CGRect, width as Single)
	...
	#tag Method, Flags = &h0
		Sub ReplacePathWithStrokedPath()
		  ...
		  #if targetMacOS
		    soft declare sub CGContextReplacePathWithStrokedPath lib CarbonFramework (c as Ptr)
	...
	#tag Method, Flags = &h0
		Sub StrokeEllipseInRect(rect as CGRect)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextStrokeEllipseInRect lib CarbonFramework (context as Ptr, rect as CGRect)
	...
	#tag Method, Flags = &h0
		Sub StrokeLineSegments(points() as CGPoint)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextStrokeLineSegments lib CarbonFramework (c as Ptr, points as Ptr, count as Integer)
	...
	#tag Method, Flags = &h0
		Function IsPathEmpty() As Boolean
		  ...
		  #if targetMacOS
		    soft declare function CGContextIsPathEmpty lib CarbonFramework (context as Ptr) as Integer
	...
	#tag Method, Flags = &h0
		Function PathCurrentPoint() As CGPoint
		  ...
		  #if targetMacOS
		    soft declare function CGContextGetPathCurrentPoint lib CarbonFramework (context as Ptr) as CGPoint
	...
	#tag Method, Flags = &h0
		Function PathBoundingBox() As CGRect
		  ...
		  #if targetMacOS
		    soft declare function CGContextGetPathBoundingBox lib CarbonFramework (context as Ptr) as CGRect
	...
	#tag Method, Flags = &h0
		Function PathContainsPoint(point as CGPoint, mode as CGPathDrawingMode) As Boolean
		  ...
		  #if targetMacOS
		    soft declare function CGContextPathContainsPoint lib CarbonFramework (context as Ptr, point as CGPoint, mode as CGPathDrawingMode) as Boolean
	...
	#tag Method, Flags = &h0
		Sub Clip()
		  ...
		  #if targetMacOS
		    soft declare sub CGContextClip lib CarbonFramework (context as Ptr)
	...
	#tag Method, Flags = &h0
		Sub EOClip()
		  ...
		  #if targetMacOS
		    soft declare sub CGContextEOClip lib CarbonFramework (context as Ptr)
	...
	#tag Method, Flags = &h0
		Sub ClipToRect(rect as CGRect)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextClipToRect lib CarbonFramework (context as Ptr, rect as CGRect)
	...
	#tag Method, Flags = &h0
		Sub ClipToRects(rects() as CGRect)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextClipToRects lib CarbonFramework (context as Ptr, rects as Ptr, count as Integer)
	...
	#tag Method, Flags = &h0
		Function ClipBoundingBox() As CGRect
		  ...
		  #if targetMacOS
		    soft declare function CGContextGetClipBoundingBox lib CarbonFramework (context as Ptr) as CGRect
	...
	#tag Method, Flags = &h0
		Sub ClipToMask(rect as CGRect, mask as CGImage)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextClipToMask lib CarbonFramework (c as Ptr, rect as CGRect, mask as Ptr)
	...
	#tag Method, Flags = &h0
		Sub SetStrokeColor(c as Color, alpha as Double = 1.0)
		  #if targetMacOS
		    soft declare sub CGContextSetRGBStrokeColor lib CarbonFramework (context as Ptr, red as Single, green as Single, blue as Single, alpha as Single)
	...
	#tag Method, Flags = &h0
		Sub SetFillColor(c as CGColor)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextSetFillColorWithColor lib CarbonFramework (context as Ptr, color as Ptr)
	...
	#tag Method, Flags = &h0
		Sub SetShadow(offset as CGSize, blur as Double)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextSetShadow lib CarbonFramework (context as Ptr, offset as CGSize, blur as Single)
	...
	#tag Method, Flags = &h0
		Sub SetShadow(offset as CGSize, blur as Double, color as CGColor)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextSetShadowWithColor lib CarbonFramework (context as Ptr, offset as CGSize, blur as Single, color as Ptr)
	...
	#tag Method, Flags = &h0
		Sub SetStrokeColor(c as CGColor)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextSetStrokeColorWithColor lib CarbonFramework (context as Ptr, color as Ptr)
	...
	#tag Method, Flags = &h0
		Function CTM() As CGAffineTransform
		  ...
		  #if targetMacOS
		    soft declare function CGContextGetCTM lib CarbonFramework (context as Ptr) as CGAffineTransform
	...
	#tag Method, Flags = &h0
		Sub ConcatCTM(transform as CGAffineTransform)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextConcatCTM lib CarbonFramework (context as Ptr, transform as CGAffineTransform)
	...
	#tag Method, Flags = &h0
		Sub RotateCTM(angle as Double)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextRotateCTM lib CarbonFramework (context as Ptr, angle as Single)
	...
	#tag Method, Flags = &h0
		Sub ScaleCTM(sx as Double, sy as Double)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextScaleCTM lib CarbonFramework (context as Ptr, sx as Single, sy as Single)
	...
	#tag Method, Flags = &h0
		Sub TranslateCTM(tx as Double, ty as Double)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextTranslateCTM lib CarbonFramework (context as Ptr, tx as Single, ty as Single)
	...
	#tag Method, Flags = &h0
		Sub DrawPDFPage(page as CGPDFPage)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextDrawPDFPage lib CarbonFramework (context as Ptr, page as Ptr)
	...
	#tag Method, Flags = &h0
		Sub DrawShading(shading as CGShading)
		  ...
		  #if targetMacOS
		    soft declare sub CGContextDrawShading lib CarbonFramework (context as Ptr, shading as Ptr)
