...
Inherits NSObject
	#tag Method, Flags = &h0
		Function ButtonPressed() As String
		  #if TargetMacOS
		    declare function buttonPressed lib "ImageCaptureCore" selector "buttonPressed" (id as Ptr) as CFStringRef
	...
	#tag Method, Flags = &h0
		Function Capabilities() As NSArray
		  #if TargetMacOS
		    declare function capabilities lib "ImageCaptureCore" selector "capabilities" (id as Ptr) as Ptr
	...
	#tag Method, Flags = &h0
		Sub CloseSession()
		  #if TargetMacOS
		    declare sub requestCloseSession lib "ImageCaptureCore" selector "requestCloseSession" (id as Ptr)
	...
	#tag Method, Flags = &h0
		Sub EjectOrDisconnect()
		  #if TargetMacOS
		    declare sub requestEjectOrDisconnect lib "ImageCaptureCore" selector "requestEjectOrDisconnect" (id as Ptr)
	...
	#tag Method, Flags = &h0
		Function HasConfigurableWiFiInterface() As boolean
		  #if TargetMacOS
		    declare function hasConfigurableWiFiInterface lib "ImageCaptureCore" selector "hasConfigurableWiFiInterface" (id as Ptr) as boolean
	...
	#tag Method, Flags = &h0
		Function HasOpenSession() As boolean
		  #if TargetMacOS
		    declare function hasOpenSession lib "ImageCaptureCore" selector "hasOpenSession" (id as Ptr) as boolean
	...
	#tag Method, Flags = &h0
		Function Icon() As Ptr
		  #if TargetMacOS
		    declare function icon lib "ImageCaptureCore" selector "icon" (id as Ptr) as Ptr
	...
	#tag Method, Flags = &h0
		Function IsRemote() As boolean
		  #if TargetMacOS
		    declare function IsRemote lib "ImageCaptureCore" selector "IsRemote" (id as Ptr) as boolean
	...
	#tag Method, Flags = &h0
		Function IsShared() As boolean
		  #if TargetMacOS
		    declare function IsShared lib "ImageCaptureCore" selector "IsShared" (id as Ptr) as boolean
	...
	#tag Method, Flags = &h0
		Function LocationDescription() As String
		  #if TargetMacOS
		    declare function locationDescription lib "ImageCaptureCore" selector "locationDescription" (id as Ptr) as CFStringRef
	...
	#tag Method, Flags = &h0
		Function Name() As String
		  #if TargetMacOS
		    declare function name lib "ImageCaptureCore" selector "name" (id as Ptr) as CFStringRef
	...
	#tag Method, Flags = &h0
		Sub OpenSession()
		  #if TargetMacOS
		    declare sub requestOpenSession lib "ImageCaptureCore" selector "requestOpenSession" (id as Ptr)
	...
	#tag Method, Flags = &h0
		Function PersistentIDString() As String
		  #if TargetMacOS
		    declare function persistentIDString lib "ImageCaptureCore" selector "persistentIDString" (id as Ptr) as CFStringRef
	...
	#tag Method, Flags = &h0
		Function serialNumberString() As String
		  #if TargetMacOS
		    declare function serialNumberString lib "ImageCaptureCore" selector "serialNumberString" (id as Ptr) as CFStringRef
	...
	#tag Method, Flags = &h0
		Function transportType() As String
		  #if TargetMacOS
		    declare function transportType lib "ImageCaptureCore" selector "transportType" (id as Ptr) as CFStringRef
	...
	#tag Method, Flags = &h0
		Function UserData() As NSMutableDictionary
		  #if TargetMacOS
		    declare function userData lib "ImageCaptureCore" selector "userData" (id as Ptr) as Ptr
	...
	#tag Method, Flags = &h0
		Function UUIDString() As String
		  #if TargetMacOS
		    declare function UUIDString lib "ImageCaptureCore" selector "UUIDString" (id as Ptr) as CFStringRef
