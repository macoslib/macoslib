...
Protected Class MacIcon
	#tag Method, Flags = &h21
		Private Function GetRect(top as Integer, left as Integer, bottom as Integer, right as Integer) As MemoryBlock
	...
	#tag Method, Flags = &h0
		Sub Draw(g as Graphics, Left as Integer, Top as Integer)
		  if g is nil then
		  ...
		  #if TargetMacOS
		    soft declare function QDBeginCGContext lib CarbonFramework (port as Integer, ByRef context as Integer) as Integer
		    soft declare sub CGContextSynchronize lib CarbonFramework (context as Integer)
		    soft declare function QDEndCGContext lib CarbonFramework (port as Integer, ByRef context as Integer) as Integer
		    soft declare function PlotIconRef lib CarbonFramework (theRect as Ptr, align as Short, transform as Short, _
		    theIconServicesUsageFlags as Integer, iconRef as Ptr) as Integer
		    soft declare function PlotIconRefInContext lib CarbonFramework (CGContextRef as Integer, theRect as Ptr, _
		    align as Short, transform as Short, ByRef labelColor as RGBColor, flags as Integer, iconRef as Ptr) as Integer
		    
		    dim error as Integer
		    dim rect as MemoryBlock
		    
		    rect = me.GetRect(Top, Left, Top + size, Left + size)
		    
		    #if false
		      // attempt (by Thomas Tempelmann) to use the newer PlotIconRefInContext() function - doesn't work yet, though
		    ...
		    #else
		      g.FillRect 0, 0, 0, 0 //sets port
		      error = PlotIconRef(rect, kAlignNone, me.pTransform, kIconServicesNormalUsageFlag, me.IconRef)
		    #endif
		  #endif
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function ContainsPoint(iconLeft as Integer, iconTop as Integer, X as Integer, Y as Integer) As Boolean
		  #if TargetMacOS
		    soft declare function PtInIconRef lib CarbonFramework (ByRef point as MacPoint, ByRef rect as MacRect, align as Int16, theIconServicesUsageFlags as Int16, theIconRef as Ptr) as Boolean
	...
	#tag Method, Flags = &h1
		Protected Function IsValidIconRef(iconRef as Ptr) As Boolean
		  #if TargetMacOS
		    soft declare function IsValidRef lib CarbonFramework Alias "IsValidIconRef" (theIconRef as Ptr) as Boolean
	...
	#tag Method, Flags = &h21
		Private Sub Constructor()
		  ...
		  me.pBackground = kThemeBrushWhite
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function Operator_Convert() As Picture
		    ...
		    if me.icon <> nil Then
		      ...
		      soft declare function SetThemeBackground Lib CarbonFramework (inBrush as Integer, inDepth as Integer, inIsColorDevice as Boolean) as Integer
		      
		      const depth = 32
		      try
		        #if false
		          // attempt (by Thomas Tempelmann) to create a picture with the correct mask. not finished yet, though.
		          declare function IsIconRefComposite lib CarbonFramework (iconRef as Ptr, ByRef bgRef as Ptr, ByRef fgRef as Ptr) as Integer
		          declare function IsIconRefMaskEmpty lib CarbonFramework (iconRef as Ptr) as Boolean
		          me.icon = new Picture(me.Size, me.Size, depth)
		          me.Draw me.icon.Graphics, 0, 0
		          if not IsIconRefMaskEmpty (me.iconRef) then
		            // plot icon mask into picture's mask
		            ...
		          end if
		        #else
		          me.icon =  new Picture(me.Size, me.Size, depth)
		          me.icon.Graphics.ClearRect 0, 0, 1, 1
		          dim OSError as Integer = SetThemeBackground(me.pBackground, depth, true)
	...
	#tag Method, Flags = &h0
		 Shared Function NewIconFromExtension(extension as String) As MacIcon
		  #if TargetMacOS
		    soft declare function GetIconRefFromTypeInfo lib CarbonFramework (inCreator as OSType, inType as OSType, inExtension as CFStringRef, inMIMEType as Ptr, inUsageFlags as Integer, ByRef outIconRef as Ptr) as Short
		    //requires OS 10.3
	...
	#tag Method, Flags = &h0
		 Shared Function NewIconFromOSInfo(creator as OSType, type as OSType) As MacIcon
		  #if TargetMacOS
		    soft declare function GetIconRef lib CarbonFramework (vRefNum as Short, creator as OSType, icnType as OSType, ByRef theIconRef as Ptr) as Short
	...
	#tag Method, Flags = &h0
		 Shared Function NewIconFromMIMEType(mimeType as String) As MacIcon
		  #if TargetMacOS
		    soft declare function GetIconRefFromTypeInfo lib CarbonFramework (inCreator as OSType, inType as OSType, inExtension as Ptr, inMIMEType as CFStringRef, inUsageFlags as Integer, ByRef outIconRef as Ptr) as Short
		    //requires OS 10.3
	...
	#tag Method, Flags = &h0
		 Shared Function NewIconFromicnsFile(icnsFile as FolderItem) As MacIcon
		    ...
		    soft declare function ReadIconFromFSRef lib CarbonFramework (ByRef theFSRef as FSRef, ByRef hndl as Ptr) as Integer
		    ...
		    soft declare sub HLockHi lib CarbonFramework (h as Ptr)
		    HLockHi familyHandle
		    
		    soft declare function GetIconRefFromIconFamilyPtr lib CarbonFramework (inIconFamilyPtr as Ptr, inSize as Integer, ByRef outIconRef as Ptr) as Integer
		    ...
		    soft declare function GetHandleSize lib CarbonFramework (h as Ptr) as Integer
		    ...
		    releaseHandle:
		    soft declare sub HUnlock Lib CarbonFramework (h as Ptr)
	...
	#tag Method, Flags = &h0
		 Shared Sub Acquire(iconRef as Ptr)
		  ...
		  #if targetMacOS
		    soft declare function AcquireIconRef lib CarbonFramework (theIconRef as Ptr) as Int16
	...
	#tag Method, Flags = &h0
		 Shared Sub Release(theIconRef as Ptr)
		  ...
		  #if TargetMacOS
		    soft declare function ReleaseIconRef lib CarbonFramework (theIconRef as Ptr) as Int16
	...
	#tag Method, Flags = &h0
		 Shared Function NewIconFromFSRef(fileRef as FSRef) As MacIcon
		    ...
		    soft declare function FSGetCatalogInfo lib CarbonFramework (ByRef ref as FSRef, whichInfo as Integer, ByRef catalogInfo as FSCatalogInfo, ByRef outName as HFSUniStr255, fsSpec as Ptr, parentRef as Ptr) as Short
		    
		    dim OSError as Integer = FSGetCatalogInfo(fileRef, kIconServicesCatalogInfoMask, catalogInfo, outFileName, nil, nil)
		    if OSError = 0 then
		      
		      soft declare function GetIconRefFromFileInfo lib CarbonFramework (ByRef inRef as FSRef, inFileNameLength as Integer, inFileName as CString, inWhichInfo as Integer, ByRef inCatalogInfo as FSCatalogInfo, inUsageFlags as Integer, ByRef outIconRef as Ptr, ByRef outLabel as Int16) as Integer
	...
	#tag Method, Flags = &h21
		Private Function IconFamilyHandle() As Integer
		  #if TargetMacOS
		    declare function IconRefToIconFamily lib CarbonFramework (refIn as Ptr, which as Integer, ByRef hdlOut as Integer) as Integer
