	...
	#tag Method, Flags = &h21
		Private Function GetItems(ByRef callbackParms as NavCBRec) As FolderItem()
		    ...
		    for index as Integer = 1 to itemCount
		      soft declare function AEGetNthPtr lib CarbonLib (ByRef theAEDesc as AEDesc, index as Integer, desiredType as OSType, ByRef theAEKeyword as OSType, ByRef typeCode as OSType, ByRef dataPtr as FSRef, maximumSize as Integer, ByRef actualSize as Integer) as Int16
		      dim keyword as OSType
		      dim typeCode as OSType = typeFSRef
		      dim theFSRef as FSRef
		      dim actualSize as Integer
		      dim OSErr as Int16 = AEGetNthPtr(theAEDesc, index, typeFSRef, keyword, typeCode, theFSRef, theFSRef.Size, actualSize)
