#tag Class
Protected Class MenuItemFormatMenu
Inherits MenuItem
	#tag Constant, Name = LocalizedText, Type = String, Dynamic = True, Default = \"Format", Scope = Public
		#Tag Instance, Platform = Any, Language = en, Definition  = \"Format"
		#Tag Instance, Platform = Any, Language = de, Definition  = \"Format"
		#Tag Instance, Platform = Any, Language = ja, Definition  = \"\xE3\x83\x95\xE3\x82\xA9\xE3\x83\xBC\xE3\x83\x9E\xE3\x83\x83\xE3\x83\x88"
