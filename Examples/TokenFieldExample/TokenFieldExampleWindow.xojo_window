...
Begin Window TokenFieldExampleWindow
   ...
   Begin GroupBox GroupBox2
      ...
      Begin Label Label1
         ...
         Transparent     =   False
         Underline       =   False
         Value           =   "The TokenField uses Tab and Return to validate each token. It also allows other characters to be used (comma by default)"
         Visible         =   True
         Width           =   279
      End
   ...
   Begin GroupBox GroupBox3
      ...
      Begin Label Label2
         ...
         Transparent     =   False
         Underline       =   False
         Value           =   "Set TokenField contents to a small list of european countries"
         Visible         =   True
         Width           =   560
      End
      ...
      Begin Label Label4
         ...
         Transparent     =   False
         Underline       =   False
         Value           =   "Get Contents and show it below"
         Visible         =   True
         Width           =   560
      End
   ...
   Begin Label Label5
      ...
      Transparent     =   False
      Underline       =   False
      Value           =   "Type in some country names in the TokenField below. You should be presented a list of suggestions. Type Tab, Return or comma to accept the suggestion.\rOnce accepted, each token is stored as an Object and the text displayed is the ISO abbreviation of the country name."
      Visible         =   True
      Width           =   714
   End
   Begin Listbox LB1
