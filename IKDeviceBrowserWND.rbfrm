...
#tag WindowCode
	#tag Event
		Sub Open()
		  ...
		  self.RestoreFrameFromWindowName   "IKDeviceBrowserWindow"
	...
	#tag Event
		Sub Action()
		  ...
		  if Cocoa.InheritsFromClass( sel, "ICScannerDevice" ) then
		    ...
		    w = new ScanningWND
		    w.IKScannerDeviceView1.ScannerDevice = new ICScannerDevice( sel, true )
		  ...
		  elseif Cocoa.InheritsFromClass( sel, "ICCameraDevice" ) then
		    ...
		    w2 = new CameraDownloadWND
		    w2.IKView.CameraDevice = new ICCameraDevice( sel, true )
...
#tag Events PushButton4
	#tag Event
		Sub Action()
		  ...
		  DReport   icd.Name
		  DReport  icd.Capabilities
		  DReport  icd.transportType
		  DReport  icd.HasOpenSession
		  DReport  icd.PersistentIDString
		  DReport  icd.serialNumberString
		  DReport  icd.UUIDString
		End Sub
	#tag EndEvent
#tag EndEvents
